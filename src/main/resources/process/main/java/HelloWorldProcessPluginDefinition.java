...
import { packageName }.spring.config.HelloWorldConfig;
...
public class HelloWorldProcessPluginDefinition extends AbstractProcessPluginDefinition
{
	...
	public Map<String, List<String>> getFhirResourcesByProcessId()
	{
		...
		return Map.of("{ organizationNameConcat }_helloUser", List.of(aHelloUser, qHelloWorld, sHelloUser, tHelloUser), "{ organizationNameConcat }_helloWorld",
